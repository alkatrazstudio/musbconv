...
```
Usage: musbconv [OPTIONS] --input-dir <INPUT_DIR> --output-dir <OUTPUT_DIR> --filename-template <FILENAME_TEMPLATE> [FFMPEG_OPTIONS]...
...
Options:
      ...
      --threads <THREADS>
          ...
          Must be between 1 and <system-dependent>.
